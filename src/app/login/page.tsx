...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col lg:flex-row bg-slate-50 dark:bg-slate-955 transition-colors duration-300">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-16 relative">
        ...
        <div className="w-full max-w-md space-y-8 relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {errorMsg && (
              <div className="p-4 bg-rose-50 dark:bg-rose-955/20 border border-rose-200 dark:border-rose-900/30 text-rose-600 dark:text-rose-455 text-xs font-bold rounded-2xl">
                {errorMsg}
              </div>
            )}
